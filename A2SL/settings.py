...
# Also include the user's roaming NLTK data directory so downloads there are found
USER_NLTK_DIR = os.path.join(os.path.expanduser('~'), 'AppData', 'Roaming', 'nltk_data')
...
try:
    ...
    # If download fails, continue - user may need to download manually
    pass
